...
class ImageService:
    ...
    @Transactional()
    async def upload_image(self, image_id: UUID4, image_base64: str, image_type: str ="", file_extension: str = "jpg", **kwargs):
        try:
    ...
    async def generate_image(self, image_id: UUID4, image_original_base64: str, image_mask_base64: str, timeout: int = 30):
        ...
        await self.upload_image(
            image_id=image_id,
            image_base64=image_original_base64,
            image_type = "original"
        )

        await self.upload_image(
            image_id=image_id,
            image_base64=image_mask_base64,
            image_type = "mask"
        )
